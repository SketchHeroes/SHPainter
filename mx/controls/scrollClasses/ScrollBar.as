package mx.controls.scrollClasses
{
   ...
   public class ScrollBar extends UIComponent
   {
      ...
      public function set scrollPosition(param1:Number) : void {
         ...
         if(this.scrollThumb)
         {
            ...
            if(!this.isScrolling)
            {
               ...
               _loc3_=_loc2_ == 0 || (isNaN(_loc2_))?0:(param1 - this.minScrollPosition) * (this.trackHeight - this.scrollThumb.height) / _loc2_ + this.trackY;
      ...
      mx_internal function lineScroll(param1:int) : void {
         ...
         {
            if(_loc3_ < this.minScrollPosition)
            {
