package mx.core
{
   ...
   public class RSLItem extends Object
   {
      ...
      public function itemErrorHandler(param1:ErrorEvent) : void {
         ...
         {
            if(param1.type == SecurityErrorEvent.SECURITY_ERROR && !(this.chainedSecurityErrorHandler == null))
            {
               this.chainedSecurityErrorHandler(param1);
            }
            else
            {
               if(param1.type == RSLEvent.RSL_ERROR && !(this.chainedRSLErrorHandler == null))
               {
