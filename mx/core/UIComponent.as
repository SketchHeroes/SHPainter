   ...
   public class UIComponent extends FlexSprite implements IAutomationObject, IChildList, IConstraintClient, IDeferredInstantiationUIComponent, IFlexDisplayObject, IFlexModule, IInvalidating, ILayoutManagerClient, IPropertyChangeNotifier, IRepeaterClient, IStateClient, IAdvancedStyleClient, IToolTipManagerClient, IUIComponent, IValidatorListener, IVisualElement
   {
      ...
      public function set cachePolicy(param1:String) : void {
         if(this._cachePolicy != param1)
         {
            ...
            {
               if(param1 == UIComponentCachePolicy.ON)
               {
      ...
      override public function addChild(param1:DisplayObject) : DisplayObject {
         ...
         var _loc3_:int = (this.effectOverlayReferenceCount) && !(param1 == this.effectOverlay)?Math.max(0,super.numChildren-1):super.numChildren;
      ...
      mx_internal function addingChild(param1:DisplayObject) : void {
         ...
         if(param1  is  IFlexModule && IFlexModule(param1).moduleFactory == null)
         {
            ...
            {
               if(this.document  is  IFlexModule && !(this.document.moduleFactory == null))
               {
                  IFlexModule(param1).moduleFactory=this.document.moduleFactory;
               }
               else
               {
                  if(this.parent  is  IFlexModule && !(IFlexModule(this.parent).moduleFactory == null))
                  {
         ...
         {
            if(param1  is  IUITextField && (IUITextField(param1).inheritingStyles))
            {
      ...
      public function validateDisplayList() : void {
         ...
         if(this.invalidateDisplayListFlag)
         {
            ...
            if(FlexVersion.compatibilityVersion < FlexVersion.VERSION_4_0)
            {
               ...
               if(Math.abs(_loc2_ - this.lastUnscaledWidth) < 1.0E-5)
               {
                  _loc2_=this.lastUnscaledWidth;
               }
               if(Math.abs(_loc3_ - this.lastUnscaledHeight) < 1.0E-5)
               {
      ...
      protected function adjustFocusRect(param1:DisplayObject=null) : void {
         ...
         if(_loc5_)
         {
            if((this.errorString) && (!(this.errorString == "")) && (this.getStyle("showErrorSkin")))
            {
            ...
            {
               _loc8_.x=_loc8_.x + this.x;
               _loc8_.y=_loc8_.y + this.y;
            }
            if(param1 != this)
            {
               if((this._layoutFeatures) && (this._layoutFeatures.mirror))
               {
                  _loc8_.x=_loc8_.x + (this.width - param1.width);
               }
            }
            ...
            {
               if(_loc5_  is  IProgrammaticSkin)
               {
      ...
      public function setCurrentState(param1:String, param2:Boolean=true) : void {
         var param1:String = this.isBaseState(param1)?this.getDefaultState():param1;
      ...
      private function getTotalDuration(param1:IEffect) : Number {
         ...
         var _loc4_:int = "repeatDelay"  in  param1?_loc3_.repeatDelay:0;
         var _loc5_:int = "repeatCount"  in  param1?_loc3_.repeatCount:0;
         var _loc6_:int = "startDelay"  in  param1?_loc3_.startDelay:0;
      ...
      private function findCommonBaseState(param1:String, param2:String) : String {
         ...
         {
            if((_loc6_.length) && _loc6_[_loc6_.length-1] == _loc3_.name)
            {
               _loc7_=_loc3_.name;
            }
         }
      ...
      private function getTransition(param1:String, param2:String) : Transition {
         ...
         while(_loc5_ < this.transitions.length)
         {
            ...
            {
               if(_loc6_.toState == param1 && _loc6_.fromState == "*" && (_loc6_.autoReverse) && _loc4_ < 2)
               {
                  _loc3_=_loc6_;
                  _loc4_=2;
               }
               ...
               {
                  if(_loc6_.toState == "*" && _loc6_.fromState == param2 && (_loc6_.autoReverse) && _loc4_ < 3)
                  {
                     _loc3_=_loc6_;
                     _loc4_=3;
                  }
                  ...
                  {
                     if(_loc6_.toState == param1 && _loc6_.fromState == param2 && (_loc6_.autoReverse) && _loc4_ < 4)
                     {
                        _loc3_=_loc6_;
                        _loc4_=4;
                     }
                     ...
                     {
                        if(_loc6_.fromState == param1 && _loc6_.toState == "*" && _loc4_ < 5)
                        {
                           _loc3_=_loc6_;
                           _loc4_=5;
                        }
                        ...
                        {
                           if(_loc6_.fromState == "*" && _loc6_.toState == param2 && _loc4_ < 6)
                           {
                              _loc3_=_loc6_;
                              _loc4_=6;
                           }
                           ...
                           {
                              if(_loc6_.fromState == param1 && _loc6_.toState == param2 && _loc4_ < 7)
                              {
                                 _loc3_=_loc6_;
                                 _loc4_=7;
                                 break;
      ...
      mx_internal function initThemeColor() : Boolean {
         ...
         {
            if((_loc1_) && (!(_loc1_  is  ISimpleStyleClient)))
            {
      ...
      public function validationResultHandler(param1:ValidationResultEvent) : void {
         ...
         else
         {
            ...
            {
               if((param1.results) && param1.results.length > 0)
               {
