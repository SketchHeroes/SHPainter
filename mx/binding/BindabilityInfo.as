   ...
   public class BindabilityInfo extends Object
   {
      ...
      public function getChangeEvents(param1:String) : Object {
         ...
         if(!changeEvents)
         {
            ...
            for each (_loc6_ in this.typeDescription.method)
            {
            ...
            childDesc=this.typeDescription.accessor.(@name == childName) + _loc3_;
      ...
      private function addBindabilityEvents(param1:XMLList, param2:Object) : void {
         ...
         this.addChangeEvents(_loc4_,eventListObj,true);
         for each (_loc7_ in metadata)
         {
            with(nextValue(_loc5_,_loc6_))
            {
         ...
         this.addChangeEvents(_loc4_,eventListObj,false);
         return;
      }
