   ...
   public class NumberBase extends Object
   {
      ...
      public function formatRounding(param1:String, param2:String) : String {
         ...
         if(param2 != NumberBaseRoundType.NONE)
         {
            ...
            {
               if(param2 == NumberBaseRoundType.DOWN)
               {
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            if("0" <= _loc5_ && _loc5_ <= "9" || _loc5_ == this.decimalSeparatorFrom)
            {
               ...
               while(_loc9_ < _loc3_)
               {
                  ...
                  {
                     if(_loc5_ == this.decimalSeparatorFrom)
                     {
                        _loc6_=_loc6_ + ".";
                     }
                     else
                     {
                        if(!(_loc5_ == this.thousandsSeparatorFrom) || _loc4_ >= _loc3_)
                        {
                           break;
                        }
                     }
      ...
      public function expandExponents(param1:String) : String {
         var _loc10_:* = NaN;
         var _loc11_:* = NaN;
         var _loc2_:RegExp = new RegExp("^([+-])?(\\d+).?(\\d*)[eE]([-+]?\\d+)$");
