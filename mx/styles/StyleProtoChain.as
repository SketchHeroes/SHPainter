package mx.styles
{
   ...
   public class StyleProtoChain extends Object
   {
      ...
      public static function initProtoChain(param1:IStyleClient) : void {
         ...
         {
            if(param1  is  IAdvancedStyleClient)
            {
               _loc12_=IAdvancedStyleClient(param1).styleParent as IStyleClient;
            }
         }
         if((_loc5_) && (_loc5_.isPopUp))
         {
            _loc15_=_loc5_._owner;
            if((_loc15_) && _loc15_  is  IStyleClient)
            {
         ...
         if((_loc2_.hasAdvancedSelectors()) && !(_loc6_ == null))
         {
            ...
            _loc3_=_loc13_ != null?_loc13_.length:0;
            _loc4_=0;
            while(_loc4_ < _loc3_)
            {
      ...
      private static function addProperties(param1:Object, param2:IStyleClient, param3:Boolean) : Object {
         ...
         else
         {
            ...
            if(_loc8_)
            {
               ...
               {
                  _loc14_=_loc8_.split(new RegExp("\\s+"));
                  _loc15_=0;
      ...
      public static function initTextField(param1:IUITextField) : void {
         ...
         if(_loc3_)
         {
            ...
            {
               _loc8_=_loc3_.split(new RegExp("\\s+"));
               _loc9_=0;
      ...
      public static function getMatchingStyleDeclarations(param1:IAdvancedStyleClient, param2:Array=null) : Array {
         ...
         var param2:Array = matchStyleDeclarations(_loc4_,param1).concat(param2);
         if(param2.length > 0)
         {
