package mx.utils
{
   ...
   public class LoaderUtil extends Object
   {
      ...
      mx_internal  static function processRequiredRSLs(param1:IFlexModuleFactory, param2:Array) : Array {
         ...
         while(_loc5_ != param1)
         {
            ...
            while(_loc13_ < _loc12_)
            {
               ...
               {
                  if(RSLData(_loc14_[0]).applicationDomainTarget == ApplicationDomainTarget.PARENT)
                  {
      ...
      private static function resolveApplicationDomainTarget(param1:Array, param2:IFlexModuleFactory, param3:IFlexModuleFactory, param4:IFlexModuleFactory, param5:IFlexModuleFactory) : Boolean {
         ...
         {
            if(_loc8_ == ApplicationDomainTarget.DEFAULT)
            {
            ...
            {
               if(_loc8_ == ApplicationDomainTarget.TOP_LEVEL)
               {
                  _loc7_=param5;
               }
               else
               {
                  if(_loc8_ == ApplicationDomainTarget.CURRENT)
                  {
                     _loc6_=true;
                  }
                  else
                  {
                     if(_loc8_ == ApplicationDomainTarget.PARENT)
                     {
                        _loc7_=param4;
                     }
                     else
