package mx.skins.halo
{
   ...
   public class SliderThumbSkin extends Border
   {
      ...
      override protected function updateDisplayList(param1:Number, param2:Number) : void {
         ...
         {
            case "thumbUpSkin":
               this.drawThumbState(param1,param2,[_loc3_,_loc7_.borderColorDrk1],[_loc5_[0],_loc5_[1]],[_loc4_[0],_loc4_[1]],true,true);
               break;
            case "thumbOverSkin":
               if(_loc5_.length > 2)
               {
               ...
               this.drawThumbState(param1,param2,[_loc7_.themeColDrk2,_loc7_.themeColDrk1],_loc9_,_loc10_,true,true);
               break;
            case "thumbDownSkin":
               this.drawThumbState(param1,param2,[_loc7_.themeColDrk2,_loc7_.themeColDrk1],[_loc7_.fillColorPress1,_loc7_.fillColorPress2],[1,1],true,false);
               break;
            case "thumbDisabledSkin":
               this.drawThumbState(param1,param2,[_loc3_,_loc7_.borderColorDrk1],[_loc5_[0],_loc5_[1]],[Math.max(0,_loc4_[0] - 0.15),Math.max(0,_loc4_[1] - 0.15)],false,false);
               break;
         }
         return;
      }
