   ...
   public class EffectManager extends EventDispatcher
   {
      ...
      private static function cacheOrUncacheTargetAsBitmap(param1:IUIComponent, param2:Boolean=true, param3:Boolean=true) : void {
         ...
         if(param2)
         {
            ...
            {
               if(_loc6_.vectorEffectsCount++ == 0 && param1  is  IDeferredInstantiationUIComponent && IDeferredInstantiationUIComponent(param1).cachePolicy == UIComponentCachePolicy.AUTO)
               {
         ...
         else
         {
            ...
            {
               if(_loc6_.vectorEffectsCount != 0)
               {
