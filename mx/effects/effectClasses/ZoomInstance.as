   ...
   public class ZoomInstance extends TweenEffectInstance
   {
      ...
      override public function play() : void {
         ...
         else
         {
            ...
            {
               if((isNaN(this.zoomHeightFrom)) && (isNaN(this.zoomHeightTo)))
               {
      ...
      private function applyPropertyChanges() : void {
         ...
         if(_loc1_)
         {
            ...
            {
               this.zoomWidthFrom=isNaN(this.zoomWidthFrom)?target.scaleX:this.zoomWidthFrom;
               this.zoomWidthTo=isNaN(this.zoomWidthTo)?_loc1_.end["scaleX"]:this.zoomWidthTo;
               _loc3_=true;
            }
            if(_loc1_.end["scaleY"] !== undefined)
            {
               this.zoomHeightFrom=isNaN(this.zoomHeightFrom)?target.scaleY:this.zoomHeightFrom;
               this.zoomHeightTo=isNaN(this.zoomHeightTo)?_loc1_.end["scaleY"]:this.zoomHeightTo;
               _loc3_=true;
            }
            if(_loc3_)
            {
      ...
      private function mouseEventHandler(param1:MouseEvent) : void {
         ...
         {
            if(param1.type == MouseEvent.ROLL_OUT || param1.type == MouseEvent.ROLL_OVER)
            {
