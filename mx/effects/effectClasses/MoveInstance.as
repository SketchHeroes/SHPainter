package mx.effects.effectClasses
{
   ...
   public class MoveInstance extends TweenEffectInstance
   {
      ...
      override public function play() : void {
         ...
         if(isNaN(this.xFrom))
         {
            this.xFrom=!isNaN(this.xTo) && !isNaN(this.xBy)?this.xTo - this.xBy:target.x;
         }
         if(isNaN(this.xTo))
         {
            ...
            {
               this.xTo=!isNaN(this.xBy)?this.xFrom + this.xBy:target.x;
            }
         }
         if(isNaN(this.yFrom))
         {
            this.yFrom=!isNaN(this.yTo) && !isNaN(this.yBy)?this.yTo - this.yBy:target.y;
         }
         if(isNaN(this.yTo))
         {
            ...
            {
               this.yTo=!isNaN(this.yBy)?this.yFrom + this.yBy:target.y;
            }
         }
