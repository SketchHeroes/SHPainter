package mx.containers.utilityClasses
{
   ...
   public class CanvasLayout extends Layout
   {
      ...
      private function applyAnchorStylesDuringUpdateDisplayList(param1:Number, param2:Number, param3:IUIComponent=null) : void {
         ...
         var param1:Number = Math.round(_loc31_ - _loc30_);
         ...
         var param2:Number = Math.round(_loc33_ - _loc32_);
         ...
         _loc23_=isNaN(_loc23_)?param3.x:_loc23_;
         _loc24_=isNaN(_loc24_)?param3.y:_loc24_;
      ...
      private function measureColumnsAndRows() : void {
         ...
         if(_loc1_.length > 0)
         {
            ...
            while(_loc3_ < _loc1_.length)
            {
               ...
               {
                  if(!isNaN(_loc13_.width) && !_loc13_.contentSize)
                  {
         ...
         if(_loc2_.length > 0)
         {
            ...
            while(_loc3_ < _loc2_.length)
            {
               ...
               {
                  if(!isNaN(_loc14_.height) && !_loc14_.contentSize)
                  {
      ...
      private function parseConstraintExp(param1:String) : Array {
         ...
         var _loc2_:String = param1.replace(new RegExp(":","g")," ");
         var _loc3_:Array = _loc2_.split(new RegExp("\\s+"));
         return _loc3_;
      }
